angular.module('plugins')
    .directive('bibliographyTargetTreechip', ['$log', '$http', 'cttvUtils', '$timeout', function ($log, $http, cttvUtils, $timeout) {
        'use strict';
        ...
        return {
            restrict: 'E',
            //require: 'resize',
            templateUrl: 'plugins/bibliography-target-treechip.html',
            scope: {
                target: '=',
                label: '='
            },
